...
gulp.task('default', function() {
	...
	console.log('gulp wordpress-lang            to compile the sostt.pot, sostt-en_EN.po and sostt-en_EN.mo');
});
...
gulp.task('wordpress-pot', function() {
	return gulp.src('**/*.php')
		...
		.pipe(wppot({
			domain: 'sostt',
			package: 'sostt',
			bugReport: 'https://github.com/lightspeeddevelopment/siteorigin-storytelling-template/issues',
			team: 'LightSpeed <webmaster@lsdev.biz>'
		}))
		.pipe(gulp.dest('languages/sostt.pot'))
});
...
gulp.task('wordpress-po', function() {
	return gulp.src('**/*.php')
		...
		.pipe(gulp.dest('languages/sostt-en_EN.po'))
});

gulp.task('wordpress-po-mo', ['wordpress-po'], function() {
	return gulp.src('languages/sostt-en_EN.po')
		.pipe(gettext())
